...
class Indonesian
{
    public array $strings = [
        ...
        'clone_success'     => 'Data berhasil diduplikasi.',
        'clone_fail'        => 'Gagal menduplikasi data.',
        ...
        'file_manager_new_folder'   => 'Folder Baru',
        'file_manager_upload'       => 'Unggah',
        'file_manager_refresh'      => 'Muat Ulang',
        'file_manager_search'       => 'Cari file...',
        'file_manager_name'         => 'Nama',
        'file_manager_size'         => 'Ukuran',
        'file_manager_modified'     => 'Diubah',
        'file_manager_empty'        => 'Folder ini kosong.',
        'file_manager_parent'       => '.. (Induk)',
        'file_manager_folders'      => 'Folder',
        'file_manager_root'         => 'Beranda',
        'file_manager_current_dir'  => 'Direktori saat ini',
        'file_manager_rename'       => 'Ubah Nama',
        'file_manager_delete'       => 'Hapus',
        'file_manager_move'         => 'Pindahkan',
        'file_manager_copy'         => 'Salin',
        'file_manager_download'     => 'Unduh',
        'file_manager_preview'      => 'Pratinjau',
        'file_manager_upload_success'   => '{count} file berhasil diunggah.',
        'file_manager_upload_error'     => 'Unggah gagal.',
        'file_manager_create_success'   => 'Folder berhasil dibuat.',
        'file_manager_rename_success'   => 'Berhasil diubah nama.',
        'file_manager_delete_success'   => 'Berhasil dihapus.',
        'file_manager_delete_confirm'   => 'Apakah Anda yakin ingin menghapus {name}?',
        'file_manager_move_success'     => 'Berhasil dipindahkan.',
        'file_manager_copy_success'     => 'Berhasil disalin.',
        'file_manager_folder_name'      => 'Nama folder',
        'file_manager_new_name'         => 'Nama baru',
        'file_manager_select_dest'      => 'Pilih tujuan',
        'file_manager_processing'       => 'Memproses...',
    ];
}
